...
export default function Home() {
  return (
   <div className="max-w-6xl mx-auto w-[90%]">
    ...
    {/* gradient blobs */}
    <div className="fixed top-0 right-0 w-48 h-48 md:w-96 md:h-96 bg-gradient-to-bl from-orange-200 via-pink-200 top-rose-300 rounded-b-full blur-2xl opacity-40 animate-pulse"></div>
